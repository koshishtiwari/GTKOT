...
export const metadata: Metadata = {
  title: 'GTKot - Modern E-Commerce Experience',
          ...
          <div className="container-custom flex justify-between items-center py-4">
            ...
            <nav className="hidden md:block">
              <ul className="flex items-center space-x-8">
                ...
                <li>
                  <Link href="/products?category=electronics" className="text-gray-700 hover:text-indigo-600 font-medium">
                    Electronics
                  </Link>
                </li>
                <li>
                  <Link href="/products?category=clothing" className="text-gray-700 hover:text-indigo-600 font-medium">
                    Clothing
                  </Link>
                </li>
              </ul>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="container-custom">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-lg font-bold mb-4">GTKot</h3>
            ...
            <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} GTKot - All rights reserved
            </div>
          </div>
        </footer>
      </body>
